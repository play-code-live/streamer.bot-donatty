...
public class CPHInline
{
    ...
    private const string RepoReleasesAPIEndpoint = "https://api.github.com/repos/play-code-live/streamer.bot-donatty/releases?per_page=100";
    ...
    public bool CheckAndAnnounce()
    {
        ...
        if (newerVersion != null)
            CPH.SendMessage(string.Format("Доступно обновление интеграции с Donatty. Версия {0} - {1}", newerVersion.TagName, newerVersion.HtmlUrl));
    ...
    private List<GitHubReleaseResponse> GetGitHubReleaseVersionsAsync()
    {
        try
        {
            ...
            webClient.Headers.Add("User-Agent", "StreamerBot Donatty Integration");
